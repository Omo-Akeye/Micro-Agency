...
export default function Home() {
  return (
    <div className="orbit-regular mt-10">
      <h1 className="font-semibold sm:text-[70.25px] sm:leading-[68.72px] sm:tracking-[-6%] text-[#000000] merriweather text-[40px] leading-[50.36px] tracking-[-8%]  max-sm:px-7">
      ...
      <section className="mt-8 flex flex-col gap-8 mb-10 max-sm:overflow-hidden">
